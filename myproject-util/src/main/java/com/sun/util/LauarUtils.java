...
//	483532, 504758 };
	...
	public static String getLunar2(String year, String month, String day) {
		Date sDObj;
//		String s;
		int SY, SM, SD;
//		int sy;
...
//		log.debug("SY=" + SY + "SM=" + SM + "SD=" + SD + "sy=" + sy);
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 100; i++) {
			y ++;
			String v = getLunar2(String.valueOf(y), "9", "21");
			if("8-15".equals(v)){
				v += " * ";
			}
			System.out.println(y + "年9月21日  阴历：" + v);
		}
		
		
		System.out.println(getLunar2("2015", "9", "27"));
